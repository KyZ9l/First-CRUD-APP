...
import com.example.libraryspring.repositories.PeopleRepository;
...
public class PeopleService {
    ...
    public Optional<Person> getPersonBuFullName(String fullName) {return peopleRepository.findByFullName(fullName);}
